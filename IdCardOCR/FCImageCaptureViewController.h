...
@protocol FCImageCaptureViewControllerDelegate <NSObject>
@required
...
@interface FCImageCaptureViewController : UIViewController <UINavigationControllerDelegate, UIImagePickerControllerDelegate>
